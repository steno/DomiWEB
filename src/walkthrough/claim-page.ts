...
<div class="shell">
  ...
  <section class="stage" aria-label="Vista previa del sitio">
    ...
    ${
      videoHref
        ? `<button type="button" class="audio-gate" id="audio-gate" aria-label="Activar audio">
      <span class="audio-gate-card">
        <strong>Toca para oír el mensaje</strong>
        <span>Los navegadores bloquean el audio automático — un toque lo activa</span>
      </span>
    </button>
    <div class="face-dock">
      <div class="bubble" id="face-bubble" title="Toca para activar el audio" role="button" tabindex="0">

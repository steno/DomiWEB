...
.edit-bar {
  ...
  border-top: 1px solid rgba(10, 143, 138, 0.22);
  gap: 0.65rem;
...
.edit-bar .btn-ghost {
  background: transparent;
  color: #10312e;
  border: 1px solid rgba(10, 143, 138, 0.35);
}
.edit-status {
  width: 100%;
  text-align: center;
...
.send-modal-card {
  width: min(26rem, 100%);
  background: #fffdf8;
  border: 1px solid rgba(10, 143, 138, 0.22);
  border-radius: 1rem;
...
body.menu-editing .top {
  /* keep forest header; content below goes coastal light */
}
...
#editar-menu .cat h2 {
  margin: 0 0 0.75rem;
  font-size: 1.25rem;
  border-bottom: 1px solid rgba(10, 143, 138, 0.22);
